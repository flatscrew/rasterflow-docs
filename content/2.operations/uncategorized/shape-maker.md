---
title: Shape Maker
description: "A meta operation to render shapes with different styles: Fill, Outline and Fill, or Outline Only."
links:
  - label: "LinuxBeaver"
...
---
alt: Shape Maker
src: /images/operations/ai-lb-shape-maker.png
---
::
...
::field-group
      ::field{name="Style" type="dictionary"}
        Select the rendering style for the shape.  
        :icon{name="i-lucide-puzzle"} Default `Fill`  
        :icon{name="i-lucide-chart-candlestick"} Possible values `Fill` • `Outline and Fill` • `Outline Only` 
      ::

      ::field{name="Grow Radius" type="gdouble"}
        Radius of the Stroke (Outline) in pixels.  
      ...
      ::
      ::field{name="Color of Outline" type="GeglColor"}
        Color of the Stroke (Outline) defaults to white.  
